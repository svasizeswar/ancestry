			...
			<div className="container">
				...
				<nav id="main-navigation" className="navbar navbar-expand-lg navbar-expand-md navbar-light">
					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						<a href="#" onClick={e => e.preventDefault()} className="navbar-toggler navbar-close" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
							<span></span>
						</a>
						<ul className="main-menu clearfix navbar-nav ml-auto">
							...
							<li className="menu-2386 last nav-item i-classfas-fa-search-i"><a href="#" onClick={e => e.preventDefault()} title="" className="nav-link"><i className="fas fa-search"></i></a></li>
						</ul>
						<form className="nav-search d-md-none" onSubmit={e => e.preventDefault()}>
